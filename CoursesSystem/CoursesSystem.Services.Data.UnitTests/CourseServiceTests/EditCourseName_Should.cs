...
{
    [TestClass]
    public class EditCourseName_Should
    {
        [TestMethod]
        public void CallCoursesUpdateMethodOnce_WhenInvokedWithValidParameters()
        {
            ...
            //Act
            courseService.EditCourseName(firstCourse.Id, courseName);
        ...
        public void CallSaverSaveChangesMethodOnce_WhenInvokedWithValidParameters()
        {
            ...
            //Act
            courseService.EditCourseName(firstCourse.Id, courseNewName);
        ...
        public void ThrowArgumentNullException_WhenCoursesAllPropertyReturnsNull()
        {
            ...
            //Act && Assert
            Assert.ThrowsException<ArgumentNullException>(() => courseService.EditCourseName(firstCourse.Id, courseNewName));
        }
        ...
        public void ThrowArgumentNullException_WhenInvokedWithInvalidNullCourseNewLecturerNameParameter()
        {
            ...
            //Act && Assert
            Assert.ThrowsException<ArgumentNullException>(() => courseService.EditCourseName(firstCourse.Id, null));
        }
        ...
        public void ThrowArgumentException_WhenInvokedWithInvalidEmptyCourseNewLecturerNameParameter()
        {
            ...
            //Act && Assert
            Assert.ThrowsException<ArgumentException>(() => courseService.EditCourseName(firstCourse.Id, string.Empty));
        }
    }
}
