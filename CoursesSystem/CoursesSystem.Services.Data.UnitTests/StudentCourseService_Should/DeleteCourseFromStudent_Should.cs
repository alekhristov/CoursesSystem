...
{
    [TestClass]
    public class DeleteCourseFromStudent_Should
    {
        [TestMethod]
        public void ThrowArgumentNullException_WhenInvokedWithInvalidNullStudentIdParameter()
        {
            ...
            //Act && Assert
            Assert.ThrowsException<ArgumentNullException>(() => studentCourseService.DeleteCourseFromStudent(Guid.NewGuid(), null));
        }
